...
output_dir = Path("/auto/data5/speechExposureEphys/LOT/tmp_datasets") / "tmp_test_randregrand"
...
from cstim.sounds.experimentsClass.element_maskingV2 import mask_and_latent_BalancedNegativesV2
